...
function displaySearch() {
    let term = `
        <div class="col-md-6 py-5">
            <input id="search" type="search" placeholder="Search By Name"  class="form-control w-75 mx-auto bg-transparent rounded-3 text-white shadow-none border-white px-3 ByName">
        </div>
        <div class="col-md-6 py-5">
            <input id="search" type="search" placeholder="Search By Frist Letter" maxlength="1" class="form-control w-75 mx-auto bg-transparent rounded-3 text-white shadow-none border-white px-3 ByFristLetter">
        </div>
    `
    $('#contact').html(null);
    $('#hero .box').html(null);
    ...
    for (let [key, value] of Area) {
        term += `
         ...
         <div onclick="filterByArea('${value.strArea}')" class="item overflow-hidden position-relative text-center py-5">
            ...
            <i class="fa-solid fa-house-laptop fa-3x" style="color: #ffffff;"></i>
...
function displayIngredients(Data) {
    ...
    for (let [key, value] of ingredients) {
        term += `
         ...
         <i class="fa-solid fa-drumstick-bite fa-3x" style="color: #ffffff;"></i>
    ...
    <form>
        <div class="row mt-3 ms-5">
            ...
            <div class="col-md-12  mt-4">
                <button type="submit" class="form-btn btn-outline-danger px-2 mt-3">Submit</button>
            </div>
        </form>
    </div>
    `
